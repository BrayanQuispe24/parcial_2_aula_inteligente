...
usuario_alumno = Usuario(
    username="Fournext", email="sebastianzc04@gmail.com", tipo_usuario="alumno", estado="activo"
)
usuario_alumno.set_password("123456")
usuario_alumno.save()

usuario_admin = Usuario(
    username="admin", email="admin@example.com", tipo_usuario="administrador", estado="activo"
)
