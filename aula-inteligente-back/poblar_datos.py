...
Usuario.objects.bulk_create([
    Usuario(username="Fournext", email="sebastianzc04@gmail.com", tipo_usuario="alumno", password=("123456"), estado="activo"),
])
...
gestion1 = Gestion.objects.create(
    ...
    fecha_culminacion="2023-12-31"
)
gestion2 = Gestion.objects.create(
    nombre="Gestion 2024",
    fecha_inicio="2024-01-01",
    fecha_culminacion="2024-12-31"
)
gestion3 = Gestion.objects.create(
    nombre="Gestion 2025",
    fecha_inicio="2025-01-01",
    fecha_culminacion="2025-12-31"
)
...
# Crear Materias asociadas a cada Nivel
Materia.objects.bulk_create([
    Materia(codigo="MAT-001", nombre="Matemáticas", carga_horaria=5.0, estado="activo", nivel=nivel1),
    ...
    Materia(codigo="MAT-005", nombre="Física", carga_horaria=4.0, estado="activo", nivel=nivel3),
    Materia(codigo="MAT-006", nombre="Química", carga_horaria=3.5, estado="activo", nivel=nivel3),
])

print("✅ Usuarios, Aulas, Gestiones (2023-2025), Trimestres, Niveles y Materias cargados exitosamente.")
